...
\vspace{10mm}
\input{Bayes_Classifier}
\input{Gradient_Descent}
\input{Bias-Complexity_Trade-off}
{\fontsize{20pt}{22pt}\selectfont \textbf{Supervised learning} \par}
\vspace{10mm}
\input{Supervised_Learning_Intro}
\input{Perceptron}
...
\vspace{10mm}
\input{Unsupervised_Learning_Intro}
\input{EM_GMM}
\input{K-means}
\input{Local_Outlier_Factor}
\input{VAE}
\vspace{10mm}
{\fontsize{20pt}{22pt}\selectfont \textbf{Reinforcement learning} \par}
\vspace{10mm}
\input{Reinforcement_Learning_Intro}
\input{Online_Estimation}
\input{Online_Control}
\input{SARSA}
\input{Q_Learning}
\end{document} 
