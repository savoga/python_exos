...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 23 17:42:24 2020

@author: savoga
"""

# dataset from http://ocelma.net/MusicRecommendationDataset/lastfm-360K.html
...
raw_data = pd.read_table('lastfm-dataset-360K/usersha1-artmbid-artname-plays.tsv', nrows=100)
...
# Note: we do not remove the MISSING values, only
# those who are equal to zero
...
# Calculate the similarity score between Jay-Z and other artists
